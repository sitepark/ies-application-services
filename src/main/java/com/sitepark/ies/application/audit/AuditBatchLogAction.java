...
public enum AuditBatchLogAction {
  ...
  BATCH_ASSIGN_ROLES_TO_USERS,
  BATCH_REASSIGN_ROLES_TO_USERS,
  BATCH_UNASSIGN_ROLES_FROM_USERS,

  // role assignment operations
  BATCH_ASSIGN_PRIVILEGES_TO_ROLES,
  BATCH_REASSIGN_PRIVILEGES_TO_ROLES,
  BATCH_UNASSIGN_PRIVILEGES_FROM_ROLES,
}
