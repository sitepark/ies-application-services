...
public class RevertLabelBatchReassignEntitiesActionHandler implements RevertEntityActionHandler {
  ...
  @Inject
  RevertLabelBatchReassignEntitiesActionHandler(
  ...
  public void revert(RevertRequest request) {
    ...
    for (String childId : childIds) {
      ...
      if (AuditLogAction.ASSIGN_LABELS_TO_ENTITIES.name().equals(auditLog.action())) {
        this.unassignLabelsFromEntitiesService.unassignLabelsFromEntities(
            UnassignLabelsFromEntitiesServiceRequest.builder()
                ...
                .build());
      } else if (AuditLogAction.UNASSIGN_LABELS_FROM_ENTITIES.name().equals(auditLog.action())) {
  ...
  private ApplicationAuditLogService createRevertBatchAssignLabelsToEntitiesLog(
    ...
    String batchId =
        auditLogService.createBatchLog(null, AuditBatchLogAction.BATCH_REASSIGN_LABELS_TO_ENTITIES);
