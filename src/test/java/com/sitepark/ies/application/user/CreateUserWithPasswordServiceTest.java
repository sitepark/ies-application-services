...
class CreateUserWithPasswordServiceTest {

  private CreateUserService createUserService;
  private SetUserPasswordUseCase setUserPasswordUseCase;
  private CreateUserWithPasswordService service;

  @BeforeEach
  void setUp() {
    this.createUserService = mock();
    this.setUserPasswordUseCase = mock();
    this.service = new CreateUserWithPasswordService(createUserService, setUserPasswordUseCase);
  }
