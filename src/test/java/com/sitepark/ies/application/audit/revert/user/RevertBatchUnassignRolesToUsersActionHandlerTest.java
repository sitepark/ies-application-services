...
class RevertBatchUnassignRolesToUsersActionHandlerTest {
  ...
  private RevertBatchUnassignRolesToUsersActionHandler handler;
  ...
  void setUp() {
    ...
    this.handler =
        new RevertBatchUnassignRolesToUsersActionHandler(
  ...
  @Test
  void testRevertCallsAssignRolesToUsersServiceForEachChild() throws IOException {
