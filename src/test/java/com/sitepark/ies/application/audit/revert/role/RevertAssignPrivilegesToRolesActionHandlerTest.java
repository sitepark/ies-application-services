...
class RevertAssignPrivilegesToRolesActionHandlerTest {
  ...
  void setUp() {
    ...
    this.handler =
        new RevertAssignPrivilegesToRolesActionHandler(
            this.auditLogService, this.unassignPrivilegesFromRolesService);
  }

  @Test
  void testRevertCallsUnassignPrivilegesFromRolesService() throws IOException {
