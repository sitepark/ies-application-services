...
class RevertLabelUnassignEntitiesActionHandlerTest {

  private AuditLogService auditLogService;
  private AssignLabelsToEntitiesService assignLabelsToEntitiesService;
  private RevertRequest request;
  private RevertLabelUnassignEntitiesActionHandler handler;
  ...
  void setUp() {
    ...
    this.handler =
        new RevertLabelUnassignEntitiesActionHandler(
            this.auditLogService, this.assignLabelsToEntitiesService);
  }

  @Test
  void testRevertCallsAssignLabelsToEntitiesService() throws IOException {
